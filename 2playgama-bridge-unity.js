...
function initializeBridge() {
    ...
    bridge
        ...
        .then(() => {
            ...
            // loader ფაილი jsdelivr-იდან
            unityLoader.src = 'https://cdn.jsdelivr.net/gh/gavicine/obbby@main/cee3bfd5589651a8b16e2a12b8abe5b3.loader.js'
            unityLoader.onload = () => {
                createUnityInstance(
                    CANVAS,
                    {
                        // გარე CDN ლინკები პირდაპირ იუნითის ინსტანსისთვის
                        dataUrl: 'https://cdn.jsdelivr.net/gh/gavicine/obbby@main/a36ce2fe211e0822e409d18ecac4ab18.data.unityweb',
                        frameworkUrl: 'https://cdn.jsdelivr.net/gh/gavicine/obbby@main/39fda71fbc54a41cc493f6c2b2bd2ec5.framework.js.unityweb',
                        codeUrl: 'https://escape-tsunami-for-brainrots.games.playgama.net/cmo2y22rb060oia0hmm8lf48s/Build/1374f7a564cf53562ec0aeffb6821470.wasm.unityweb',
                        streamingAssetsUrl: 'StreamingAssets',
                        companyName: 'Square Dino LLC',
                        productName: 'Obby Run Tsunami _ Brainrots',
